            ...
            {mode === 'guest' ? (
              <>
                ...
                <div className="px-3.5 pt-3">
                  ...
                  {guideItem('#fef3c7','🍖','BBQ Grill','Charcoal — bring your own','Charcoal barbecue grills are available on the property. <strong>Charcoal is NOT provided</strong> — please bring your own. Clean the grill after use. Grills are shared — be considerate of other guests. Grilling tools are in the kitchen.')}
