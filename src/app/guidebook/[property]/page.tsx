            ...
            {mode === 'guest' ? (
              <>
                ...
                <div className="px-3.5 pt-3">
                  ...
                  {guideItem('#dbeafe','🏊','Pool & Pavilion Rules','Hours, safety & policies','<strong>Hours:</strong> 8 AM – 10 PM daily<br><br><strong>Rules:</strong> No glass containers in the pool area. Children must be supervised at all times. No diving or running. Pool towels are provided in the unit — please do not take bath towels to the pool.<br><br>The pavilion/shelter is available for guest use. Please clean up after yourself and be considerate of other guests.')}
                  {guideItem('#d1fae5','🌿','Outdoor Recreation','Lake, trail, playground & more','<strong>🏞️ Private Lake (Pond):</strong> A short walk from the property. Catch-and-release fishing allowed. The walking trail circles the lake. Please supervise children near the water.<br><br><strong>🚶 Walking Trail:</strong> Scenic trail circling the lake, maintained year-round. Perfect for morning walks.<br><br><strong>🛝 Playground:</strong> Near the main pool — swings and a slide. Adult supervision required.<br><br><strong>🏀 Basketball:</strong> Hoop near the pool area. Balls may be in the unit.<br><br><strong>🥏 Horseshoes:</strong> Pits near the pool. Horseshoes in the unit closet or ask Brian.')}
                  {guideItem('#fef3c7','🍖','BBQ Grill','Location, usage & cleanup','Propane barbecue grills are available on the property. Please clean the grill after use. The grill is shared — be considerate of other guests. Propane is provided. Grilling tools are in the kitchen.')}
                  {guideItem('#e0f2fe','🪙','Coin Laundry','Shared facility near main pool','Coin-operated washers and dryers are located near the main pool. Machines accept quarters. A starter supply of detergent pods is provided in your unit. Additional detergent is available for purchase at the laundry facility. <strong>Hours:</strong> Available during pool hours (8 AM – 10 PM). ⏯️ <a href="https://www.youtube.com/watch?v=IlJQi1S0NRI" target="_blank" style="color:#166534;">Video walkthrough</a>')}
                  {guideItem('#fce7f3','🎒','Things to Bring','Recommended packing list','🧴Sunblock & bug spray<br>🩴Pool/beach towels for the lake<br>🎣 Fishing gear if you plan to fish<br>🧺 Cooler for lake days<br>🧼 Extra laundry detergent if doing multiple loads<br>🪙 Quarters for coin laundry<br>🥾 Comfortable walking shoes for the trail<br><br>⏯️ <a href="https://www.youtube.com/watch?v=2DvVB7xTuNk" target="_blank" style="color:#166534;">Watch: Things to Bring video guide</a>')}
                  <div className="bg-white rounded-lg mb-1 border border-stone-100 overflow-hidden">
                    <details className="group">
                      <summary className="flex items-center gap-2 px-3.5 py-3 cursor-pointer list-none">
