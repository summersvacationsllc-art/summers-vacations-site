            ...
            {mode === 'guest' ? (
              <>
                ...
                <div className="px-3.5 pt-3">
                  ...
                  {(isModern || isPeacock) && guideItem('#fce7f3','🎮','Games are in the entrance cabinet with the painted door.','Board games & blankets','In the two ottomans you will find board games and extra blankets for cozy nights in.')}
