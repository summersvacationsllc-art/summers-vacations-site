            ...
            {mode === 'guest' ? (
              <>
                ...
                <div className="px-3.5 pt-3">
                  ...
                  {(isModern || isPeacock) && guideItem('#fef3c7','🛋️','Family Room','Queen sleeper sofa','The family room is the perfect place to relax after a long, adventurous day. There is a cozy couch that transforms into a queen size sleeper sofa.  a set of sheets are in the left and right ottoman for the pull out sleeper.')}
                  {(isModern || isPeacock) && guideItem('#fce7f3','🎮','Games are in the entrance cabinet with the painted door.','','')}
        ...
        {tab === 'adventure' && (
          <>
            ...
            <div className="grid grid-cols-2 gap-2 px-3.5 pb-1.5">
              {[{e:'🎡',t:'Ferris Wheel',d:'The Boardwalk',l:'https://bransontracks.com/'},{e:'⚡',t:'Xtreme Racing',d:'Indoor go-karts',l:'https://www.xtremeracingcenter.com/'},{e:'🌊',t:'White Water',d:'SDC water park!',l:'https://www.silverdollarcity.com/white-water/'},{e:'🚂',t:'Scenic Railway',d:'Scenic train ride',l:'https://www.bransontrain.com/'},{e:'🦋',t:'Butterfly Palace',d:'Live butterflies!',l:'https://www.thebutterflypalace.com/'},{e:'🥏',t:'Parakeet Pete\'s',d:'Zipline + balloon',l:'https://bransonlandingattractions.com/'}].map((x,i)=>(
                <a key={i} href={x.l} target="_blank" rel="noopener" className="block bg-white rounded-lg px-3 py-2.5 border border-sky-100 no-underline text-inherit"><div className="text-xl">{x.e}</div><div className="text-[13px] font-bold text-sky-900 mt-0.5">{x.t}</div><div className="text-[11px] text-sky-700">{x.d}</div></a>
              ))}
            </div>
